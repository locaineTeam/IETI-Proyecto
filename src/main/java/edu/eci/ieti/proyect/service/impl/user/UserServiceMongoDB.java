...
public class UserServiceMongoDB implements UserService {
    ...
    private String[] nombres = {"Mamberroy Jr", "El Guajiro", "El calvo", "El sucio Dann", "Mona china", "Sempai Alexander", "MySpace user", "Mario Neta","Elsa Yajin","Elma Amador","Elsa Nahoria", "Rosa Melalma", "Elena Nito","Valentina Mor Velazquez", "Hombre oso cerdo", "Roller Fox", "Yanfri Weisnner" };
